...
<div class="story">
   ...
   <ul>
		...
		<li>15Mar10 <a href="<?= $urlPrefix ?>timeforjustice/files/2010315_JoeBiden.pdf" target="_blank">Email to Joe Biden (though whitehouse.gov)</a> (39kb).</li>
		<li>29Jan10 <a href="<?= $urlPrefix ?>timeforjustice/files/20100130_IsraeliAmbassador.pdf" target="_blank">Letter to Israeli Ambassador</a> (39kb).</li>
		<li>24Apr09 <a href="<?= $urlPrefix ?>timeforjustice/files/20090424_IsraeliAmbassador.pdf" target="_blank">Letter to Israeli Ambassador</a> (25kb).</li>
		<li>29Jan09 <a href="<?= $urlPrefix ?>timeforjustice/files/20090129_60MinutesComments.pdf" target="_blank">Comments on <i>60 Minutes</i> discussion board</a> (76kb).</li>
		<li>27Jan09 <a href="<?= $urlPrefix ?>timeforjustice/files/20090127_Obama.pdf" target="_blank">Letter to President Obama</a> (695kb).</li>
		<li>27Jan09 <a href="<?= $urlPrefix ?>timeforjustice/files/20090127_Clinton.pdf" target="_blank">Letter to Secretary of State Clinton</a> (695kb).</li>
		<li>25Jan09 <a href="<?= $urlPrefix ?>timeforjustice/files/20090125_60Minutes.pdf" target="_blank">Comments and Feedback to <i>60 Minutes</i></a> (77kb).</li>
		<li>10Jan09 <a href="<?= $urlPrefix ?>timeforjustice/files/20090110_ABCNews.pdf" target="_blank">Email to ABC News</a> (27kb).</li>
		<li>9Jan09 <a href="<?= $urlPrefix ?>timeforjustice/files/20090109_Bush.pdf" target="_blank">Letter to President Bush</a> (889kb).</li>
		<li>6Jan09 <a href="<?= $urlPrefix ?>timeforjustice/files/20090106_Cohen.pdf" target="_blank">Email to Washington Post columnist Richard Cohen</a> (32kb).</li>
		<li>3Jan09 <a href="<?= $urlPrefix ?>timeforjustice/files/20090103_WashingtonPostComment.pdf" target="_blank">Comment left on Washington Post website in response to an article</a> (34kb).</li>
		<li>1Jan09 <a href="<?= $urlPrefix ?>timeforjustice/files/20090101_IsraeliAmbassador.pdf" target="_blank">Letter to Israeli Ambassador</a> (41kb).</li>
		<li>1Jan09 <a href="<?= $urlPrefix ?>timeforjustice/files/20090101_EgyptianAmbassador.pdf" target="_blank">Letter to Egyptian Ambassador</a> (19kb).</li>
		<li>31Dec08 <a href="<?= $urlPrefix ?>timeforjustice/files/20081231_ABCNews.pdf" target="_blank">Email to ABC News</a> (26kb).</li>
		<li>31Dec08 <a href="<?= $urlPrefix ?>timeforjustice/files/20081231_Express.pdf" target="_blank">Email to Express newspaper</a> (498kb).</li>
	 
		<li>5Oct08 <a href="<?= $urlPrefix ?>timeforjustice/files/20081005_WashPostEditorial.pdf" target="_blank">Washington Post Editorial</a> (obviously I did not write this).</li>
		<li>25Feb07 <a href="<?= $urlPrefix ?>timeforjustice/files/20070225_NPR.pdf" target="_blank">Email to NPR</a> after they spoke with the Israeli Ambassador.</li>
		<li>26Jul04 <a href="<?= $urlPrefix ?>timeforjustice/files/20040726_AustGovt_reply.pdf" target="_blank">Reply from Australian government</a> although again, I can't find the original.</li>
		<li>24Jun04 <a href="<?= $urlPrefix ?>timeforjustice/files/20040624_Bush_reply.pdf" target="_blank">Reply from President Bush</a> (500kb) but I've lost the letter I sent!</li>
		<li>7Oct03 <a href="<?= $urlPrefix ?>timeforjustice/files/20031007_Bush.pdf" target="_blank">Letter to President Bush</a> (110kb).</li>
		<li>29Sep02 <a href="<?= $urlPrefix ?>timeforjustice/files/20020929_60Minutes.pdf" target="_blank">Letter to <i>60 Minutes</i></a> (35kb).</li>
		<li>Sep02 (?) <a href="<?= $urlPrefix ?>timeforjustice/files/20020900_Newsweek.pdf" target="_blank">Letter to Newsweek</a> (1.2MB). This was written in response to a letter suggesting I renew my subscription. Unfortunately I didn't date it but it is after the bombing mentioned above and "two years" after the start of the second <i>intifada</i> which places it at September 2002.</li>
		<li>23Jul02 <a href="<?= $urlPrefix ?>timeforjustice/files/20020723_DenverPost.pdf" target="_blank">Newspaper clipping</a> (1.1MB) after Israeli used a US-made plane to drop a US-made bomb on an apartment building with the aim of assassinating a Hamas leader. I wrote a <a href="<?= $urlPrefix ?>timeforjustice/files/20020818_NighthorseAllardDeGette.pdf">letter to Senators Nighthorse-Campbell &amp; Allard and Congresswoman DeGette</a> (218kb) and include here the <a href="<?= $urlPrefix ?>timeforjustice/files/20020818_Nighthorse_reply.pdf">reply from Nighthorse-Campbell</a> (402kb) and the <a href="files/20020818_Allard_reply.pdf">reply from Allard</a> (767kb).</li>
		<li>6May02 <a href="<?= $urlPrefix ?>timeforjustice/files/20020506_Armey.pdf" target="_blank">Letter to Congressman Dick Armey</a> (23kb) and his <a href="<?= $urlPrefix ?>timeforjustice/files/20020506_Armey_reply.pdf">reply</a> (530kb)</li>
		<li>22Apr02 <a href="<?= $urlPrefix ?>timeforjustice/files/20020422_Bush.pdf" target="_blank">Letter to President Bush</a> (26kb).</li>
		<li>16Apr02 <a href="<?= $urlPrefix ?>timeforjustice/files/20020416_Wolfowitz.pdf" target="_blank">Letter to Paul Wolfowitz</a> (16kb).</li>
		<li>15Apr02 <a href="<?= $urlPrefix ?>timeforjustice/files/20020415_Rooney.pdf" target="_blank">Letter to Andy Rooney of <i>60 Minutes</i> (20kb).</a></li>
		<li>9Apr02 <a href="<?= $urlPrefix ?>timeforjustice/files/20020409_IsraeliEmbassy.pdf" target="_blank">Letter to Israeli Ambassador</a> (21kb).</li>
		<li>1Apr02 <a href="<?= $urlPrefix ?>timeforjustice/files/20020401_60Minutes.pdf" target="_blank">Letter to <i>60 Minutes</i></a> (62kb).</li>
		<li>1Feb02 <a href="<?= $urlPrefix ?>timeforjustice/files/20020201_60Minutes.pdf" target="_blank">Letter to <i>60 Minutes</i></a> (22kb).</li>
		<li>20Jul01 <a href="<?= $urlPrefix ?>timeforjustice/files/20010720_Newsweek.pdf" target="_blank">Analysis of <i>Newsweek</i>'s coverage</a> (7.1MB). I was aware that <i>Newsweek</i>'s coverage was biased but I didn't realize how blatant it was until I did a systematic review. I was surprised that it didn't prompt even a generic response.</li>
	 </ul>
</div>
...
<div class="story">
   ...
   <ul>
      <li>16Jul06 <a href="<?= $urlPrefix ?>timeforjustice/files/20060716_IsraeliEmbassy.pdf" target="_blank">Letter to Israeli Ambassador</a> (21kb).</li>
      <li>16Jul06 <a href="<?= $urlPrefix ?>timeforjustice/files/20060717_WarnerAllenMoran.pdf" target="_blank">Letter to Senators Warner &amp; Allen and Congressman Moran</a> and the <a href="<?= $urlPrefix ?>timeforjustice/files/20060717_Warner_reply.pdf">reply from Warner</a> (794kb) and the <a href="<?= $urlPrefix ?>timeforjustice/files/20060717_Moran_reply.pdf">reply from Moran</a> (815kb)</li>
   </ul>
</div>
...
<div class="story">
   ...
   <ul>
      <li>3Aug07 <a href="<?= $urlPrefix ?>files/20070803_NPR.pdf" target="_blank">Email to NPR</a> (28kb).</li>
   </ul>
</div>
