	...
	<div class="story">
		...
		<p>We expected them to jump on the issues raised by the DCRA inspector that issued the Order and work would resume within a few days. Instead it took two whole months until the Order was lifted but then another 6 weeks or so before work really got started again. In the meantime, the windows had been delivered so they installed them to get them out of the way - it was a pity that they didn't bother to repair the window frames first (<?php setTextLinkToPicture("WindowFrameScraped2Sm.jpg", "this one") ?> for example). At the time the windows were only held in by a few screws each side so I assumed they would be removed to repair the frames but then they were painted and the gaps filled with expanding foam. As you can see <?php setTextLinkToPicture("WindowFramePrimedSm.jpg", "here") ?>, it looked terrible and it indicated that they weren't going to do proper paint preparation so I bought a sander and did <?php setTextLinkToPicture("WindowFrameSandedSm.jpg", "one window") ?> myself to show the standard I expected . It seemed ridiculous that I should have to do that. </p>
		...
		<p>Since the basement was complete, we've had problems with water penetration and the builder addressed most of them in some way or other. After heavy rains we saw this <?php setTextLinkToPicture("BasementWetPatch1Sm.jpg", "wet patch") ?> under the middle basement window and the damp patch at the <?php setTextLinkToPicture("BasementWetPatch2Sm.jpg", "floor") ?> actually formed puddles. With dampness like this, we can't finish the basement so we are witholding payment. </p>
		...
		<p>Additionally, while we recognize that the a significant amount of work was done on the repairing the floors, the floor in the living room still doesn't look right as seen <?php setTextLinkToPicture("Floorboards1Sm.jpg", "here") ?> and <?php setTextLinkToPicture("Floorboards2Sm.jpg", "here") ?>. There are a few other minor things but that covers the main issues.</p>
