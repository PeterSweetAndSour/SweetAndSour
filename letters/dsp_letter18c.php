...
<div class="story">
	...
	<ul>
   	<li><span class="sticker">There&apos;s no place like 127.0.0.1</span><br />(A special one for web developers!)</li>
  	<li><span class="sticker">Give dad a fish and he&apos;ll eat it.<br />Teach dad to fish and he&apos;ll sit on the dock and drink beer.
</span></li>
	</ul>
</div>
...
<div class="story">
   <p>Previous: <a class="previousPage" href="<?= $rootRelativeUrl ?>letters/letter18b">Sightseeing</a></p>
</div>
...
<div class="story footnotes">
   ...
   <ol class="endText" start="12">
		<li>
			...
			<br><a href="#Note12Ref" class="noteGoBack">Go back</a>
		</li>
		<li>
			...
			<br><a href="#Note13Ref" class="noteGoBack">Go back</a>
		</li>
	</ol>
</div>
