...
<div class="story">
   <p><a name="Note12Ref"></a>After we got married I read an excellent book  about the Vietnam conflict<sup><a href="#Note12">Note&nbsp;12</a></sup> and I was struck by the disparity between the optimistic assessments at the time from those in power and what was being reported. I was amazed to see history repeating itself in Iraq—until just a few months ago. Now nobody, except perhaps the President, sees anything but a catastrophe. Responsibility and the blame to come are now being pushed on to the Iraqis, much as the Vietnamization policy attempted earlier.</p>
...
<div class="story">
	<ul>
  	...
  	<li><span class="sticker">One person, one vote*.<br />*May not apply in some states.</span></li>
   	<li><span class="sticker">God bless the whole world.<br />No exceptions.</span><br />(In contrast to the numerous <i>God Bless America</i> stickers.)</li>
  	<li><span class="sticker">Honor the dead. Heal the wounded. End the war.</span></li>
   	<li><span class="sticker">Invest in weapons of mass instruction.</span></li>
	</ul>
	<p>On a light-hearted note, I can only offer these but they are good:</p>
	<ul>
   	<li><span class="sticker">There&rsquo;s no place like 127.0.0.1</span><br />(A special one for web developers!)</li>
  	<li><span class="sticker">Give dad a fish and he&rsquo;ll eat it.<br />Teach dad to fish and he&rsquo;ll sit on the dock and drink beer.
</span></li>
	</ul>
</div>
...
<div class="story footnotes">
   ...
   <ol class="endText" start="12">
		<li>
			<a name="Note12"></a><i>Vietnam—A History</i>, Stanley Karnow
			<a href="#Note12Ref"><img src="<?= $backIconSrc ?>" height="10" width="12" alt="Back to where you were" border="0" /></a>&nbsp;<i>Back</i>
		</li>
		<li>
			<a name="Note13"></a>See <a href="http://amtraders.com/c-detail.asp?Model=Feather&Material=WE" target="_blank" class="external">manufacturer&rsquo;s picture</a>. We bought it second hand and paid a little over one-quarter list price though it does have some obvious wear and tear.
