...
<div class="story">
   <p>Alexandria is just across the Potomac River from Washington so there is a vast array of things to see and do. Our neighbors from Denver came to visit and after touring the Whitehouse, they had this fortuitous encounter on the street as you can see in the first picture!</p>
...
<div class="story">
	...
	Previous: <a class="previousPage" href="<?= $rootRelativeUrl ?>letters/letter18c">Disconnect from reality</a></p>
</div>
...
<div class="story footnotes">
   ...
   <ol class="endText" start="3">
		...
		<li>
			...
			Also the <a href="<?= $rootRelativeUrl ?>wherewelive/washington">view from the top</a>.
		...
		<li>
			<a name="Note10"></a>No room here to show many pictures but we have <a href="<?= $rootRelativeUrl ?>photos/photos">lots more</a> of this beautiful country.
