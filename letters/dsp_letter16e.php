...
<div>
   ...
   <?
   setThumbnail("CanalDuMidi1.jpg");
   setThumbnail("Carcassone1.jpg");
   setThumbnail("Chenonceau1.jpg");
   setThumbnail("Villandry1.jpg");
   setThumbnail("AzayLeRideau1.jpg");
   setThumbnail("Usse1.jpg");
   setThumbnail("Chambord1.jpg");
   setThumbnail("MontStMichel1.jpg");
   ?>
</div>
...
<div class="story">
   ...
   <p>Continue to <a href="index.php?fuseAction=letter16f">France, part 3</a> (page 6) <a href="index.php?fuseAction=letter16f"><img src="<?= $continueIconSrc ?>" height="13" border="0" style="vertical-align:bottom"></a></p>
