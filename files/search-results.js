const searchResults = (function() {
	...
	const _getSearchResults = function() {
		...
		const server_Peoplesoft_URL = "//sweetandsour.org/api/search-results-peoplesoft.js?search-term=" + searchTerm; // To PeopleSoft
		const server_New_ATS_URL = "//sweetandsour.org/api/search-results-new-ats.js?search-term=" + searchTerm; // To new ATS for pilot agencies
