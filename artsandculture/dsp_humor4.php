...
<div class="story">
   ...
   Greg Bulmash</p>
   <p>SEX:<br />
   Not yet. Still waiting for the right person.</p>
   <p>DESIRED POSITION:<br />
   Company's President or Vice President. But seriously, what ever's available. If I was in a position to be picky, I wouldn't be applying here in the first place.</p>
   <p>DESIRED SALARY:<br />
   $185,000 a year plus stock options and a Michael Ovitz-style severance package. If that's not possible, make an offer and we can haggle.</p>
   <p>EDUCATION:<br />
   Yes.</p>
   <p>LAST POSITION HELD:<br />
   Target for middle management hostility.</p>
   <p>SALARY:<br />
   Less than I'm worth.</p>
   <p>MOST NOTABLE ACHIEVEMENT:<br />
   My incredible collection of stolen pens and Post-It notes.</p>
   <p>REASON FOR LEAVING:<br />
   It sucked.</p>
   <p>HOURS AVAILABLE TO WORK:<br />
   Any.</p>
   <p>PREFERRED HOURS:<br />
   1:30 - 3:30 p.m., Monday, Tuesday, and Thursday.</p>
   <p>DO YOU HAVE ANY SPECIAL SKILLS?<br />
   Yes, but they're better suited to a more intimate environment.</p>
   <p>MAY WE CONTACT YOUR CURRENT EMPLOYER?<br />
   If I had one, would I be here?</p>
   <p>DO YOU HAVE ANY PHYSICAL CONDITIONS THAT WOULD PROHIBIT YOU FROM LIFTING UP TO 50 LBS?<br />
   Of what?</p>
   <p>DO YOU HAVE A CAR?<br />
   I think the more appropriate question here would be, <i>&quot;Do you have a car that runs?&quot;</i></p>
   <p>HAVE YOU RECEIVED ANY SPECIAL AWARDS OR RECOGNITION?<br />
   I may already be a winner of the Publishers Clearing House Sweepstakes.</p>
   <p>DO YOU SMOKE?<br />
   On the job no, on my breaks yes.</p>
   <p>WHAT WOULD YOU LIKE TO BE DOING IN FIVE YEARS?<br />
   Living in the Bahamas with a fabulously wealthy, dumb sexy blonde super model, who thinks I'm the greatest thing since sliced bread. Actually, I'd like to be doing that now.</p>
   <p>DO YOU CERTIFY THAT THE ABOVE IS TRUE AND COMPLETE TO THE BEST OF YOUR KNOWLEDGE?<br />
   Yes, Absolutely.</p>
   <p class="endText">SIGN HERE:<br />
   Aries.</p>
</div>
...
<div class="story">
   ...
   <ul class="endText">
   	...
   	<li>There is no fool like ... Aunt Edie.</li>
   	<li>Laugh and the world laughs with you.  Cry and .. you have to blow your nose.</li>
   </ul>
</div>
...
<div class="story">
   ...
   <p>What? Of course, you don't want to be bored. Who does? Life here is tough and demanding, but it's also fun. MIT students are imaginative and creative - inside and outside the classroom.</p>
   ...
   <p>Sincerely,</p>
   <p>Michael C. Benhke<br />
   Director of Admissions</p>
   <p class="endText">P.S. If you'd like a copy of a fun-filled, fact-filled brochure, <i>&quot;Insight&quot;</i>, just check the appropriate box on the form.</p>
   <br />
   <hr>
   <br />
   <p>May 5, 1994<br />
   <p>Michael C. Behnke<br />
   MIT Director of Admissions<br />
   Office of Admissions, Room 3-108<br />
   ...
   <p>But you're not most universities. And that's exactly why I urge you to carefully consider one of the most selective students in America, so selective that he will choose only *one* of the thousands of accredited universities in the country.</p>
   ...
   <p>What? Of course you don't want egotistical jerks. Who does? I am self-indulgent and over confident, but I'm also amusing. John Mongan is funny and amusing - whether you're laughing with him or at him.</p>
...
<h4>MARTIN MOLLOY</h4>
<div class="story">
   <p>Often crude, always silly and sometimes hilarious, this comedy duo hosts Australian afternoon drivetime radio.  <i>"Please explain"</i> was their best effort, with my favourite caller being the man enquiring about high voltage power lines.  He was wondering why the sign on the fence at the base of the tower said <i>"DANGER!  KEEP OUT! 500,000 volts.  DEATH BY ELECTROCUTION!"</i> and then in smaller letters <i>"Penalty for trespassing $500"</i>.</p>
   <p>Lan and I often repeat Mick's suggestion on a phrase that could be used in a commercial for dairy-based spreads, <i>"Well bugger me.  It <b>IS</b> butter!"</i>.</p>
...
<div class="story">
   <p>Able to capture difficult concepts in a single sentence, he could have made a handsome living from bumper stickers if they had been invented a century earlier.  This site is one of many featuring his wit.  For example: <i>"One man alone can be pretty dumb sometimes, but for real bona fide stupidity there ain't nothing can beat teamwork."</i></p>
   <p class="endText"><a class="external" href="http://www.phnet.fi/public/mamaa1/twain.htm" target="_blank">Mark Twain quotes</a></p>
</div>

<h4>MISHEARD SONG LYRICS</h4>
<div class="story">
   <p>A site devoted to misheard lyrics of popular songs.  The name is taken from a misunderstanding of the line <i>" 'scuse me while I kiss the sky"</i>  in Jimi Hendrix's <i>"Purple Haze"</i>.  I knew a girl who thought the GoGo's were singing about <i>"Alex the seal"</i> instead of <i>"Our lips are sealed"</i>.  This errror is not mentioned but there are six others!  The listing for AC/DC's <i>"You shook me all night long"</i> is both hilarious and frightening!</p>
