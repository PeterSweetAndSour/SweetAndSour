<div class="story">
	<p>This section is going to expand as I get familiar with the camera, tripod and software. Here are a few to get started.</p>
	<p>When the panorama is loading, it may appear to get stuck at 80%. It probably isn&rsquo;t. This just means that the image is loaded but decompression is not complete so be a little patient.</p> 
	<p>Your browser must be <b>Java-enabled</b> to view the panoramas. If it isn&rsquo;t, you should get instructions on downloading the plugin from Sun. The applet viewer is open-source by <a href="http://www.path.unimelb.edu.au/~dersch/" target="_blank" class="external">Helmut Dersch</a>.</p>
...
<? setThumbnail("panoramaGrandLake1a.jpg", "", "true"); ?>
