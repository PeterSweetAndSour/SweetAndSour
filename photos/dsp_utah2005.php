...
<div class="photoAlbum">
	<?
	setThumbnail("restAreaI70sm.jpg");
	setThumbnail("SanRaphaelCanyonsm.jpg");
	?>
</div>
...
<div class="photoAlbum">
	<div class="photoBox">
   	<div class="imgShadow">
   		<a href="/photos/images/UtahTrip/BRYCECANYONPANO_1.htm"><img src="../photos/images/UtahTrip/BryceCanyonPanoLink.jpg" width="150" height="112" alt="Refer to caption" /></a>
   	</div>
   	<div class="caption captionThumb">Queen&rsquo;s Garden looking from above. Panorama!</div>
  </div>
   <?
   setThumbnail(
		array(
