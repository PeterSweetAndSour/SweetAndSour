...
if (!window['google']['loader']) {
	...
	google.loader.ApiKey = 'ABQIAAAAKZa0m7K346FCikKHHE-NgRR8wM3bJBMlRhAtPYyu9yNs3cni-BRTweLyvA1cMNrN0zjIV7JZ2-aRzg';
	...
	(function () {
		...
		google.P = function (a, b) {
			if (b) {
				if (P[x] == 0) {
					...
					else(E("safari") || E("konqueror")) && l[z](aa, 10)
				}
				P[q](a)
			} else Q(l, "load", a)
		};
		
		L("google.setOnLoadCallback", google.P);
		...
		L("google.loader.domReady", google[A].K);
		var ca = {
			loaded: d,
			complete: d
		};
		...
		function aa() {
			if (ca[o.readyState]) R();
			else P[x] > 0 && l[z](aa, 10)
		}
		...
		L("google.loader.rfm", google[A].M);
		google[A].O = function (a) {
			for (var b in a) if (typeof b == "string" && b && b[s](0) == ":" && !N[b]) N[b] = new T(b[B](1), a[b])
		};
		L("google.loader.rpl", google[A].O);
		google[A].N = function (a) {
			if ((a = a.specs) && a[x]) for (var b = 0; b < a[x]; ++b) {
				var c = a[b];
				if (typeof c == "string") N[":" + c] = new U(c);
				else {
					c = new V(c[v], c.baseSpec, c.customSpecs);
					N[":" + c[v]] = c
				}
			}
		};
		
		L("google.loader.rm", google[A].N);
		...
		L("google.loader.createGuidArg_", google[A].J);
		J("google_exportSymbol", J);
		J("google_exportProperty", K);
		
		google[A].b = {};
		L("google.loader.themes", google[A].b);
		google[A].b.z = "http://www.google.com/cse/style/look/bubblegum.css";
		M(google[A].b, "BUBBLEGUM", google[A].b.z);
		google[A].b.B = "http://www.google.com/cse/style/look/greensky.css";
		M(google[A].b, "GREENSKY", google[A].b.B);
		google[A].b.A = "http://www.google.com/cse/style/look/espresso.css";
		M(google[A].b, "ESPRESSO", google[A].b.A);
		google[A].b.D = "http://www.google.com/cse/style/look/shiny.css";
		M(google[A].b, "SHINY", google[A].b.D);
		google[A].b.C = "http://www.google.com/cse/style/look/minimalist.css";
		M(google[A].b, "MINIMALIST", google[A].b.C);
		...
		U[y].k = function (a) {
			if (this.c != -1) {
				X("al_" + this.a, "jl." + ((new Date)[w]() - this.c), d);
				this.c = -1
			}
			...
			for (var b = 0; b < a.components[x]; b++) {
				...
				if (c) {
					for (var e = 0; e < c[x]; e++) c[e].I(a.components[b]);
		...
		T[y].g = function (a, b) {
			...
			c = google[A].GoogleApisBase + "/libs/" + this.a + "/" + a + "/" + this.f.versions[":" + a][b && b.uncompressed ? "uncompressed" : "compressed"];
			X("el", this.a);
			return c
		};
		T[y].s = function () {
		...
		var da = h,
			...
			X = function (a, b, c) {
				if (!da) {
					var e = !E("opera") && E("firefox") ? "beforeunload" : "unload";
					Q(l, e, fa);
					da = d
				}
				if (c) {
			...
			fa = function () {
				if (Z[x]) {
					var a = google[A][u];
					if (E("opera") && a[t]("http:") == 0) a = a[r](/http:/, "https:");
	...
	google.loader.rfm({
		":search": {
			...
			"path": "/api/search/1.0/e266cfa875b6dca1dcc49b8b12376c11/",
			"js": "default+en.I.js",
			"css": "default.css",
			"properties": {
				":JSHash": "e266cfa875b6dca1dcc49b8b12376c11",
				":NoOldNames": false,
				":Version": "1.0"
			}
		},
		":language": {
			...
			"path": "/api/language/1.0/967daad8b24523f19546cb65092bf0d4/",
			"js": "default+en.I.js",
			"properties": {
				":JSHash": "967daad8b24523f19546cb65092bf0d4",
				":Version": "1.0"
			}
		},
		":wave": {
		...
		":earth": {
			...
			"path": "/api/earth/1.0/00d105d1c73075289f85070f5c796e56/",
			"js": "default.I.js",
			"properties": {
				":JSHash": "00d105d1c73075289f85070f5c796e56",
				":Version": "1.0"
			}
		},
		":annotations": {
			...
			"path": "/api/annotations/1.0/07e907d9b9df53fd5aeac223152f4748/",
			"js": "default+en.I.js",
			"properties": {
				":JSHash": "07e907d9b9df53fd5aeac223152f4748",
				":Version": "1.0"
			}
		}
	});
