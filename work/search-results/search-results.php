<?php /*
Use this page to scan a View > Source of the eRecruit search results pageto build 
a JSON output half of which can then be copied to api/search-results-new-ats.js
and the rest to api/search-results-peoplesoft.js. */

// https://www.zenrows.com/blog/web-scraping-php#get-data
include_once("./includes/simple_html_dom.php");

// Get the search term from the URL - actually, we aren't using this now
$searchTerm =  $_GET["position"];

// Query PeopleSoft for jobs with this search term - I could not get this to work
...
// so had to work with a dump of the page source
$url = "./search-results-accountant.html";
...
<head>
  ...
  <title>Search Jobs</title>
	...
	<link href="css/search-results-styles-from-peoplesoft.css" rel="stylesheet">
