...
(function (factory) {
  ...
  L.Control.Search = L.Control.extend({
    ...
    options: {
      ...
      autoCollapseTime: 3000, // delay for autoclosing alert and collapse after blur
    ...
    expand: function (toggle) {
      ...
      this._input.style.display = 'inline-block' /* This was 'block' */
    ...
    _createButton: function (title, className) {
      ...
      button.title = title
        ...
        .on(button, 'click', function(evt) {
          this._handleSubmit();
          this.options.allowKeypressSubmit = false;
          setTimeout(() => {
            this.options.allowKeypressSubmit = true;
          }, 500);
         }, this)
    ...
    _handleKeypress: function (e) { // run _input keyup event
      ...
      switch (e.keyCode) {
        ...
        case 13:  /* Enter */
          ...
          if(this.options.allowKeypressSubmit) {
