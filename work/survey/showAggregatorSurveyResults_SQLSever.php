<?php
if(isset($_GET["limit"])) {
	// Block inputs larger than 3 characters to guard against SQL injection but allow limit to 999.
...
if(isset($_GET["offset"])) {
	// Block inputs larger than 5 characters to guard against SQL injection but allow offset to 99,999.
